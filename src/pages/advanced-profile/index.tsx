...
@connect(
  ({
    ...
    advancedProfile: AdvancedProfileData;
    loading: {
...
class AdvancedProfile extends Component<
  { loading: boolean; advancedProfile: AdvancedProfileData; dispatch: Dispatch<any> },
  AdvancedProfileState
> {
  public state: AdvancedProfileState = {
    operationKey: 'tab1',
    tabActiveKey: 'detail',
  };
